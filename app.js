...
///mongoose config
mongoose.connect('mongodb://104.236.253.101:2107/ByOwner_database', function(err){if(!err)console.log('Successfully connected to database!!');if(err)console.log(err)});
